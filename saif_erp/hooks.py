...
fixtures = [
	...
	{"doctype": "Custom Field", "filters": [["name", "in", [
		...
		"Job Order-cb_identifiers", "Job Order-cb_proposal", "Job Order-cb_advance", "Job Order-cb_company", "Job Order-cb_drafta", "Job Order-cb_draftb", "Job Order-cb_customer", "Job Order-cb_service", "Job Order-cb_service2",
